...
Configuration management for the worktree-bootstrap plugin, covering initialization, modification, and display of `.worktreeinclude.yaml` configuration files.
